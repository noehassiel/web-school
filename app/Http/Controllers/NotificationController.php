...
class NotificationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('back.notifications.index')->with('mail', $mail)->with('template', $template);
    }
    ...
    public function all()
    {
        ...
        return view('back.notifications.all', compact('notifications'));
    }
    ...
    public function registerUser($name, $email)
    {
        ...
        Mail::send('mail.new_user', $data, function($message) use($name, $email, $sender_email, $store_name) {
    ...
    public function resendOrder(Request $request, $order_id) {
        ...
        try {
            Mail::send('mail.order_completed', $data, function($message) use($name, $email, $sender_email, $store_name) {
     ...
     public function orderDelivered($order_id) {
        ...
        try {
            Mail::send('mail.order_delivered', $data, function($message) use($name, $email, $sender_email, $store_name) {
                $message->to($email, $name)->subject
                ('¡Gracias por comprar con nosotros!');
    ...
    public function attachment_email() {
        ...
        Mail::send('mail.order_completed', $data, function($message) {
