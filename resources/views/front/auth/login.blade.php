@extends('front.auth.layout.main')

@push('stylesheets')

<style>
  body{
    background-image: url({{ asset('img/bk.jpg') }})
  }
</style>
...
<div class="blurred-box">
  ...
  <!--  for demo purposes only and its shit  -->
    <div class="cartoon-container d-flex justify-content-center position-relative mb-3" style="z-index: 1">
